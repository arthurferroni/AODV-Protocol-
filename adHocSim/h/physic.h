...
#include "costants.h"
//in order to avoid the scan of evry module,
...
//
// FIXME it is definately a bad idea to subclass for cObject and use
// cArray for storage. Should be changed to a plain struct, and
// stored in std::vector. --Andras
//
